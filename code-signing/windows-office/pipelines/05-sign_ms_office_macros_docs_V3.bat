...
call offsign_ub_ksp_runner.bat -i ..\signed_files\book_with_macro_signed.xlsm -c %cert% -p test -u sasha -w Password1! -t http://timestamp.digicert.com
...
call offsign_ub_ksp_runner.bat -i ..\signed_files\word_doc_with_macros_signed.docm -c %cert% -p test -u sasha -w Password1! -t http://timestamp.digicert.com
