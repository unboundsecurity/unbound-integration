...
// https://stackoverflow.com/questions/6357759/has-anyone-got-any-code-to-call-signersignex-from-c
namespace SignApp
{
    class CodeSigner
    {
        ...
        private static X509Certificate FindCertByThumbnail(string thumbnail)
        {
            try
            {
                //thumbnail = thumbnail.Replace("\u200e", string.Empty).Replace("\u200f", string.Empty).Replace(" ", string.Empty);
        ...
        private static void SignCode(IntPtr pSubjectInfo, IntPtr pSignerCert, IntPtr pSignatureInfo)
        {
            ...
            Console.WriteLine("Successfully singed");
        }
