...
public class TokenizeHandler implements RequestHandler<TokenizationRequest, TokenizationResponse> , TokHandler {
    ...
    public TokenizationResponse handleRequest(TokenizationRequest request, Context context) {
        ...
        try {
            ...
            String token = sessionKey.encryptEMailAddress(request.getValue(), request.getMaxSize());
